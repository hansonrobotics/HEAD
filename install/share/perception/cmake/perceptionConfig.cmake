...
if("FALSE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/icog-labs/hansonrobotics/HEAD/src/vision/perception)
  set(perception_DEVEL_PREFIX /home/icog-labs/hansonrobotics/HEAD/devel/.private/perception)
  ...
  set(perception_INSTALL_PREFIX /home/icog-labs/hansonrobotics/HEAD/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vytas Krisčiunas <vytas@hansonrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/icog-labs/hansonrobotics/HEAD/install/${idir}'.  Ask the maintainer 'Vytas Krisčiunas <vytas@hansonrobotics.com>' to fix it.")
    endif()
