...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_pololu-msg:<MotorCommand> is deprecated: use ros_pololu-msg:MotorCommand instead.")))

(cl:ensure-generic-function 'joint_name-val :lambda-list '(m))
(cl:defmethod joint_name-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pololu-msg:joint_name-val is deprecated.  Use ros_pololu-msg:joint_name instead.")
  (joint_name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pololu-msg:position-val is deprecated.  Use ros_pololu-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pololu-msg:speed-val is deprecated.  Use ros_pololu-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pololu-msg:acceleration-val is deprecated.  Use ros_pololu-msg:acceleration instead.")
  (acceleration m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotorCommand>)))
  ...
  "c357daac337dac3f7e4bb73a055e6e8c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotorCommand)))
  "Returns md5sum for a message object of type 'MotorCommand"
  "c357daac337dac3f7e4bb73a055e6e8c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorCommand>)))
  ...
  (cl:format cl:nil "string joint_name       # Name of the joint (specified in the yaml file), or motor_id for default calibration~%float64 position        # Position to move to in radians~%float32 speed           # Speed to move at (0.0 - 1.0)~%float32 acceleration    # Acceleration to move at (0.0 - 1.0)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorCommand)))
  "Returns full string definition for message of type 'MotorCommand"
  (cl:format cl:nil "string joint_name       # Name of the joint (specified in the yaml file), or motor_id for default calibration~%float64 position        # Position to move to in radians~%float32 speed           # Speed to move at (0.0 - 1.0)~%float32 acceleration    # Acceleration to move at (0.0 - 1.0)~%~%~%"))
