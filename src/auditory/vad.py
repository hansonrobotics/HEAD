...
class VAD(object):
    ...
    def moattar_homayounpour(wave_file, average_intensity, instances):
        ...
        print len(samples)
        print struct.calcsize("%dh" % (n_frames))
...
if __name__ == "__main__":
    ...
    voi.write_to_new_file(filenameOneChannel,x)
    print VAD.moattar_homayounpour(filenameOneChannel, 0, 0)