    ...
    for row in csvData:
        if row['Meaning']!=currentMeaning:
            ...
            if state=='init':
                ...
                # hit next meaning so create category of single  and srais pointing to it
        ...
        slots = {};
        slots['Pattern']="*"; slots['That']="*" ; slots['Template']=""; slots['Topic']="*";  slots['Think']=""
...
def generateAimlFromLongCSV(csvData):
    ...
    for row in csvData:
        ...
        if row['Type']=='pattern':
            ...
            slots = {};
            slots['Type']="*"; slots['Pattern']="*"; slots['That']="*" ; slots['Template']=""; slots['Topic']="*";  slots['Think']=""
            temp_random=[]
            srai=[]
            if (row['Pattern']!=""):
