...
<html lang="en">
<head>
    <title>Code coverage report for backgrid-paginator/backgrid-paginator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">backgrid-paginator/</a> backgrid-paginator.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">90.59% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>77/85</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  // CommonJS
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof exports == "object") {
<span class="cstat-no" title="statement not covered" >    module.exports = factory(require("underscore"),</span>
                             require("backbone"),
                             require("backgrid"),
...
<span class="cstat-no" title="statement not covered" >    define(["underscore", "backbone", "backgrid", "backbone.paginator"], factory);</span>
  }
  // Browser
  else {
...
&nbsp;
    ...
    */
    render: function () {
      ...
      anchor.href = '#';
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.title) anchor.title = this.title;
...
&nbsp;
    ...
    */
    changePage: function (e) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!$el.hasClass("active") &amp;&amp; !$el.hasClass("disabled")) {
...
&nbsp;
      _.extend(self, _.pick(options || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> "windowSize", "pageHandle",
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (currentPage &lt;= lastPage - this.slideThisMuch()) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Apr 11 2016 04:21:13 GMT+0100 (BST)
</div>
</div>
