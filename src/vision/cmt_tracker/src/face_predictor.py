...
class face_predictor:
  ...
  def callback(self,data, cmt, face,temp):
    ...
    ttp = cmt
    # To also account for temporary trackers in the system state.
    ...
    # Not Covered Faces #May be here we can add a filter also to check for past instaces of a face location.
