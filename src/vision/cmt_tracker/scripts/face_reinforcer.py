...
class face_reinforcer:
    ...
    def callback(self, cmt, face, temp):
        ...
        for a, b in itertools.combinations(ttp.tracker_results, 2):
            ...
            SI = max(0, (
                max(a.object.object.x_offset + a.object.object.width,
                    b.object.object.x_offset + b.object.object.width) - min(
    ...
    def returnOverlapping(self, face, cmt):
        ...
        for i in cmt.tracker_results:
            ...
            if (area > self.area_scale * (self.camera_width * self.camera_height)):
                ...
                self.not_good_holder[i.tracker_name.data] = self.not_good_holder.get(i.tracker_name.data,
                                                                                     self.repeat(5))[1:] + "1"
        ...
        self.persistance_face[:] = [get_element for get_element in self.persistance_face if
                                    not (self.trim(get_element[6], self.window_size))]
